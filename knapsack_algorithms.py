...
def run_optimal_dynamic_programming(knapsack_instances):
    totals = []
    running_times = []
    ...
    for j in knapsack_instances:
        ...
        # rows, cols = (len(j.items)+1, j.capacity)
...
optimal_dynamic_programming_results = run_optimal_dynamic_programming(k_instances)
